function updatePreview() {
    ...
    showCheck("nozzle_3ways", "previewNozzle3ways");
    showCheck("nozzle_sterilization", "previewNozzleSterilization");
    ...
    showCheck("self_cleaning_nozzle", "previewSelfCleaningNozzle");
    ...
    selectText("controller_type", "previewControllerType");
    selectText("nozzle_material", "previewNozzleMaterial");
    selectText("tank_type", "previewTankType");
    selectText("controller_waterproof", "previewControllerWaterproof");
    selectText("main_body_waterproof", "previewMainBodyWaterproof");
    selectText("remote_waterproof", "previewRemoteWaterproof");
}
